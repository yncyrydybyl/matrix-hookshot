    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/bot-commands' },
      {
        ...
        items: [
          ...
          { text: '1.8.1', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.8.1/' },
          { text: '1.8.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.8.0/' },
          { text: '1.7.3', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.7.3/' },
          { text: '1.7.2', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.7.2/' },
          { text: '1.7.1', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.7.1/' },
          { text: '1.7.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.7.0/' },
          { text: '1.6.1', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.6.1/' },
          { text: '1.6.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.6.0/' },
          { text: '1.5.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.5.0/' },
          { text: '1.4.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.4.0/' },
          { text: '1.3.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.3.0/' },
          { text: '1.2.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.2.0/' },
          { text: '1.1.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.1.0/' },
          { text: '1.0.0', link: 'https://yncyrydybyl.github.io/matrix-hookshot/1.0.0/' },
        ],
      },
    ],
