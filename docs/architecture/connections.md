...
<!-- Code: src/Connections/IConnection.ts:30-117, src/Connections/BaseConnection.ts:7-23 -->
...
<!-- Code: src/Connections/ directory -->
...
<!-- Code: src/Connections/SetupConnection.ts -->
...
<!-- Code: src/widgets/BridgeWidgetApi.ts:28-122, src/ConnectionManager.ts:91 -->
...
<!-- Code: src/Bridge.ts:1024-1115 (room processing on startup, concurrency of 2) -->
...
<!-- Code: src/Connections/GenericHook.ts:531-560 (state update with transformation recompile) -->
...
<!-- Code: IConnection.migrateToNewRoom, src/Bridge.ts room.event handler for m.room.tombstone -->
...
<!-- Code: src/Connections/CommandConnection.ts, src/BotCommands.ts:15-176 -->
...
<!-- Code: src/ConnectionManager.ts:47-100 -->
...
<!-- Code: See any connection class for reference. GenericHook.ts is the simplest webhook-based connection. FeedConnection.ts is the simplest polling-based connection. -->
